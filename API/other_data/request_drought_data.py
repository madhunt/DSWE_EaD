''' 
Script for downloading JSON data from the US Drought Monitor
https://droughtmonitor.unl.edu/
'''

import requests

def download_json_data(start_date, end_date, area_of_interest,
    ...
    if statistics_format not in ['1','2']:
...
#response = download_json_data('1/1/2012', '1/1/2013', 'us',
